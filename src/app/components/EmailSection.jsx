...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid md:grid-cols-2 my-12 md:my-12 py-4 gap-4 relative"
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-lg text-xl">
          {" "}
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Aniket-404">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/aniket-kamble-873613221/">
            <Image src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
          <a href="mailto:kamble.aniket.ak47@gmail.com">
